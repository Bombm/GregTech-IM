...
public class MetaTileEntityLockedSafeMV extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    public int unlockComponentTier = 2;
    ...
    public MetaTileEntityLockedSafeMV(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityLockedSafeMV(metaTileEntityId);
    }
