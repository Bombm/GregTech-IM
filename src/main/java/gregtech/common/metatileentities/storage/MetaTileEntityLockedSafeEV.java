...
public class MetaTileEntityLockedSafeEV extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    public int unlockComponentTier = 4;
    ...
    public MetaTileEntityLockedSafeEV(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityLockedSafeEV(metaTileEntityId);
    }
