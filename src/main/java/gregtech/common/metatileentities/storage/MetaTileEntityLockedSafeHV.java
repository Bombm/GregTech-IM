...
public class MetaTileEntityLockedSafeHV extends MetaTileEntity implements IFastRenderMetaTileEntity {
    ...
    public int unlockComponentTier = 3;
    ...
    public MetaTileEntityLockedSafeHV(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityLockedSafeHV(metaTileEntityId);
    }
