...
public class MetaTileEntityChunkMiner extends TieredMetaTileEntity implements Miner {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        Textures.ROCK_CRUSHER_OVERLAY.renderSided(EnumFacing.UP, renderState, translation, pipeline);
        Textures.PIPE_OUT_OVERLAY.renderSided(getFrontFacing().getOpposite(), renderState, translation, pipeline);
        Textures.MINER_ACTIVE.renderSided(getFrontFacing(), renderState, translation, pipeline);
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gregtech.machine.miner.fluid_usage", type.drillingFluidConsumePerTick, I18n.format(Materials.DrillingFluid.getFluid(0).getUnlocalizedName())));
        tooltip.add(I18n.format("This machine's is made by gregicality! Go check out their addon, it's really cool!"));
    }
