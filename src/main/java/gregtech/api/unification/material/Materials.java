...
public class Materials {
    ...
    public static IngotMaterial Copper = new IngotMaterial(18, "copper", 0xFF8000, MaterialIconSet.SHINY, 1, of(), EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_DENSE | GENERATE_PLASMA, Element.Cu);
    ...
    public static IngotMaterial Gold = new IngotMaterial(26, "gold", 0xFFFF00, MaterialIconSet.SHINY, 2, of(), EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, Element.Au);
    ...
    public static IngotMaterial Iron = new IngotMaterial(33, "iron", 0xAAAAAA, MaterialIconSet.METALLIC, 2, of(), EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_DENSE | GENERATE_FRAME | GENERATE_LONG_ROD | GENERATE_PLASMA | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, Element.Fe, 7.0F, 2.5f, 256);
    ...
    public static IngotMaterial Niobium = new IngotMaterial(45, "niobium", 0x9486AA, MaterialIconSet.METALLIC, 2, of(), STD_METAL | GENERATE_ORE | GENERATE_PLASMA, Element.Nb, 2750);
    ...
    public static IngotMaterial Tin = new IngotMaterial(71, "tin", 0xDCDCDC, MaterialIconSet.DULL, 1, of(), EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_ROTOR | GENERATE_ORE | GENERATE_PLASMA, Element.Sn);
    ...
    public static DustMaterial Bone = new DustMaterial(93, "bone", 0xFFFFFF, MaterialIconSet.ROUGH, 1, of(new MaterialStack(Calcium, 1)), MORTAR_GRINDABLE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES);
    ...
    public static GemMaterial Coal = new GemMaterial(106, "coal", 0x464646, MaterialIconSet.LIGNITE, 1, of(new MaterialStack(Carbon, 1)), GENERATE_ORE | FLAMMABLE | NO_SMELTING | NO_SMASHING | MORTAR_GRINDABLE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES);
    ...
    public static DustMaterial MagnesiumChloride = new DustMaterial(125, "magnesium_chloride", 0xD40D5C, MaterialIconSet.ROUGH, 2, of(new MaterialStack(Magnesium, 1), new MaterialStack(Chlorine, 2)), DISABLE_DECOMPOSITION);
    ...
    public static IngotMaterial Rubber = new IngotMaterial(152, "rubber", 0x151515, MaterialIconSet.ROUGH, 0, of(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 8)), GENERATE_PLATE | GENERATE_GEAR | GENERATE_RING | FLAMMABLE | NO_SMASHING | GENERATE_RING | NO_WORKING | DISABLE_DECOMPOSITION);
    public static DustMaterial RawRubber = new DustMaterial(153, "raw_rubber", 0xCCC789, MaterialIconSet.SAND, 0, of(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 8)), DISABLE_DECOMPOSITION);
    ...
    public static FluidMaterial Steam = new FluidMaterial(346, "steam", 0xFFFFFF, MaterialIconSet.GAS, of(new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 1)), NO_RECYCLING | GENERATE_FLUID_BLOCK | DISABLE_DECOMPOSITION).setFluidTemperature(380);
    ...
    public static GemMaterial NetherQuartz = new GemMaterial(201, "nether_quartz", 0xE6D2D2, MaterialIconSet.QUARTZ, 1, of(), STD_SOLID | NO_SMELTING | CRYSTALLISABLE | GENERATE_ORE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES);
     ...
     * Stargate materials
     */
    public static IngotMaterial Naquadah = new IngotMaterial(307, "naquadah", 0x323232, MaterialIconSet.METALLIC, 4, of(), EXT_METAL | GENERATE_ORE | GENERATE_PLASMA, Element.Nq, 6.0F, 4.0f, 1280, 5400);
    ...
    public static IngotMaterial NaquadahEnriched = new IngotMaterial(309, "naquadah_enriched", 0x282828, MaterialIconSet.METALLIC, 4, of(), EXT_METAL | GENERATE_ORE | GENERATE_PLASMA, Element.Nq, 6.0F, 4.0f, 1280, 4500);
    public static IngotMaterial Naquadria = new IngotMaterial(310, "naquadria", 0x1E1E1E, MaterialIconSet.SHINY, 3, of(), EXT_METAL | GENERATE_PLASMA, Element.Nr, 9000);
    public static IngotMaterial Tritanium = new IngotMaterial(311, "tritanium", 0xFFFFFF, MaterialIconSet.METALLIC, 6, of(), EXT_METAL | GENERATE_PLASMA, Element.Tr, 20.0F, 6.0f, 10240);
    public static IngotMaterial Duranium = new IngotMaterial(312, "duranium", 0xFFFFFF, MaterialIconSet.METALLIC, 5, of(), EXT_METAL | GENERATE_PLASMA, Element.Dr, 16.0F, 5.0f, 5120);
    ...
    public static FluidMaterial Krypton = new FluidMaterial(536, "krypton", 0xc6f5f2, MaterialIconSet.GAS, of(), STATE_GAS | GENERATE_PLASMA, Element.Kr);
    public static FluidMaterial Xenon = new FluidMaterial(554, "xenon", 0x2554b3, MaterialIconSet.GAS, of(), STATE_GAS | GENERATE_PLASMA, Element.Xe);

    public static FluidMaterial Bromium  = new FluidMaterial(535, "bromium", 0x733318, MaterialIconSet.GAS, of(), DISABLE_DECOMPOSITION | GENERATE_PLASMA, Element.Br);

    public static IngotMaterial Germanium = new IngotMaterial(532, "germanium", 0x7f8f8d, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_RING | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_LONG_ROD | GENERATE_FRAME | GENERATE_ORE | GENERATE_PLASMA, Element.Ge, 3.0F, 2.0f, 512);
    public static IngotMaterial Zirconium = new IngotMaterial(540, "zirconium", 0x95c98d, MaterialIconSet.METALLIC, 3, of(), EXT2_METAL | GENERATE_RING | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_LONG_ROD | GENERATE_FRAME | GENERATE_ORE | GENERATE_PLASMA, Element.Zr, 5.0F, 6.0f, 2800, 1852);
    public static IngotMaterial Technetium = new IngotMaterial(543, "technetium", 0xc1d4d2, MaterialIconSet.METALLIC, 4, of(),GENERATE_PLASMA | GENERATE_ORE, Element.Tc);
    public static IngotMaterial Rutenium = new IngotMaterial(544, "rutenium", 0xf50039, MaterialIconSet.METALLIC, 4, of(), GENERATE_ORE | GENERATE_FINE_WIRE | NO_SMELTING | GENERATE_PLASMA, Element.Ru);
    public static IngotMaterial Rhodium = new IngotMaterial(545, "rhodium", 0xf5587d, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLATE | GENERATE_ROD | GENERATE_LONG_ROD | GENERATE_ORE | NO_SMELTING | GENERATE_PLASMA, Element.Rh);
    public static IngotMaterial Hafnium = new IngotMaterial(572, "hafnium", 0x396923, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR |NO_SMELTING | GENERATE_FRAME | GENERATE_PLASMA, Element.Hf);
    public static IngotMaterial Rhenium = new IngotMaterial(575, "rhenium", 0x6fc0e3, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLATE | NO_SMELTING | GENERATE_PLASMA, Element.Re);
    public static IngotMaterial Thallium = new IngotMaterial(581, "thallium", 0xc5bbc7, MaterialIconSet.METALLIC, 4, of(), NO_SMELTING | GENERATE_PLASMA, Element.Tl);
    public static IngotMaterial Polonium = new IngotMaterial(584, "polonium", 0xa0baa7, MaterialIconSet.METALLIC, 4, of(), GENERATE_ROD | GENERATE_LONG_ROD | GENERATE_PLASMA, Element.Po);
    public static IngotMaterial Francium = new IngotMaterial(587, "francium", 0xcc3943, MaterialIconSet.METALLIC, 4, of(),  STATE_GAS | GENERATE_PLASMA, Element.Fr);
    public static IngotMaterial Rhadium = new IngotMaterial(588, "rhadium", 0x5f8f11, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLATE | NO_SMELTING | GENERATE_PLASMA, Element.Ra);
    public static IngotMaterial Actinium = new IngotMaterial(589, "actinium", 0x7ca387, MaterialIconSet.METALLIC, 4, of(), NO_SMELTING | GENERATE_PLASMA, Element.Ac);
    public static IngotMaterial Protactinium = new IngotMaterial(591, "protactinium", 0x1eeb58, MaterialIconSet.SHINY, 4, of(), NO_SMELTING | GENERATE_PLASMA, Element.Pa);
    public static IngotMaterial Neptunium237 = new IngotMaterial(593, "neptunium237", 0x3885a6, MaterialIconSet.METALLIC, 3, of(), GENERATE_PLATE | GENERATE_ROD | GENERATE_LONG_ROD | GENERATE_GEAR | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Np);
    public static IngotMaterial Uranium239 = new IngotMaterial(719, "uranium239", 0x1ff034, MaterialIconSet.METALLIC, 3, of(), GENERATE_ORE | GENERATE_PLATE | GENERATE_ROD | GENERATE_LONG_ROD | GENERATE_PLASMA, Element.U);
    public static IngotMaterial Curium247 = new IngotMaterial(596, "curium247", 0x9a4f9c, MaterialIconSet.METALLIC, 3, of(), NO_SMELTING | GENERATE_PLASMA, Element.Cm);
    public static IngotMaterial Berklium = new IngotMaterial(597, "berklium", 0x353623, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLASMA, Element.Bk);
    public static IngotMaterial Californium = new IngotMaterial(598, "californium", 0xfab54d, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLATE | GENERATE_PLASMA, Element.Cf);
    public static IngotMaterial Einsteinium = new IngotMaterial(599, "einsteinium", 0x086bff, MaterialIconSet.METALLIC, 4, of(), NO_SMELTING | GENERATE_PLASMA, Element.Es);
    public static IngotMaterial Fermium = new IngotMaterial(600, "fermium", 0x120a8f, MaterialIconSet.METALLIC, 4, of(), NO_SMELTING | GENERATE_PLASMA, Element.Fm);
    public static IngotMaterial Mendelevium = new IngotMaterial(601, "mendelevium", 0x297828, MaterialIconSet.METALLIC, 4, of(),NO_SMELTING | GENERATE_PLASMA, Element.Md);
    public static IngotMaterial Nobelium = new IngotMaterial(602, "nobelium", 0xcae5db, MaterialIconSet.METALLIC, 4, of(), GENERATE_PLASMA, Element.No);
    public static IngotMaterial Lawrencium = new IngotMaterial(603, "lawrencium", 0x47b320, MaterialIconSet.METALLIC, 5, of(),NO_SMELTING | GENERATE_PLASMA, Element.Lr);
    public static IngotMaterial Rutherfordium = new IngotMaterial(604, "rutherfordium", 0x9e260b, MaterialIconSet.METALLIC, 5, of(), GENERATE_PLASMA, Element.Rf);
    public static IngotMaterial Dubnium = new IngotMaterial(605, "dubnium", 0x0008ff, MaterialIconSet.METALLIC, 5, of(), GENERATE_PLASMA, Element.Db);
    public static IngotMaterial Seaborgium = new IngotMaterial(606, "seaborgium", 0xe86bae, MaterialIconSet.METALLIC, 5, of(), GENERATE_PLASMA, Element.Sg);
    public static IngotMaterial Bohrium = new IngotMaterial(607, "bohrium", 0x38a307, MaterialIconSet.METALLIC, 5, of(), GENERATE_PLASMA, Element.Bh);
    public static IngotMaterial Hassium = new IngotMaterial(608, "hassium", 0x8d9491, MaterialIconSet.METALLIC, 5, of(), NO_SMELTING | GENERATE_PLASMA, Element.Hs);
    ...
    public static IngotMaterial Tennessine = new IngotMaterial(617, "tennessine", 0x3bff96, MaterialIconSet.METALLIC, 5, of(), GENERATE_PLASMA, Element.Ts);
    public static IngotMaterial Ununennium = new IngotMaterial(619, "ununennium", 0xff7878, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Uue_stable);
    public static IngotMaterial Unbinilium = new IngotMaterial(620, "unbinilium", 0xdb6565, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubn_stable);
    public static IngotMaterial Unbiunium = new IngotMaterial(621, "unbiunium", 0xb85454, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubu_stable);
    public static IngotMaterial Unbibium = new IngotMaterial(622, "unbibium", 0x873e3e, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubb_stable);
    public static IngotMaterial Unbitrium = new IngotMaterial(623, "unbitrium", 0x5c2a2a, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubt_stable);
    public static IngotMaterial Unbiquadium = new IngotMaterial(624, "unbiquadium", 0x381a1a, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubq_stable);
    public static IngotMaterial Unbipentium = new IngotMaterial(625, "unbipentium", 0x0d0606, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubp_stable);
    public static IngotMaterial Unbihexium = new IngotMaterial(626, "unbihexium", 0x870000, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubh_stable);
    public static IngotMaterial Unbiseptium = new IngotMaterial(627, "unbiseptium", 0xf00, MaterialIconSet.ROUGH, 7, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubs_stable);
    public static IngotMaterial UnunenniumUnstable = new IngotMaterial(722, "unstable_ununennium", 0xff7878, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Uue);
    public static IngotMaterial UnbiniliumUnstable = new IngotMaterial(723, "unstable_unbinilium", 0xdb6565, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubn);
    public static IngotMaterial UnbiuniumUnstable = new IngotMaterial(724, "unstable_unbiunium", 0xb85454, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubu);
    public static IngotMaterial UnbibiumUnstable = new IngotMaterial(725, "unstable_unbibium", 0x873e3e, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubb);
    public static IngotMaterial UnbitriumUnstable = new IngotMaterial(726, "unstable_unbitrium", 0x5c2a2a, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubt);
    public static IngotMaterial UnbiquadiumUnstable = new IngotMaterial(727, "unstable_unbiquadium", 0x381a1a, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubq);
    public static IngotMaterial UnbipentiumUnstable = new IngotMaterial(728, "unstable_unbipentium", 0x0d0606, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubp);
    public static IngotMaterial UnbihexiumUnstable = new IngotMaterial(729, "unstable_unbihexium", 0x870000, MaterialIconSet.ROUGH, 6, of(), GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubh);
    public static IngotMaterial UnbiseptiumUnstable = new IngotMaterial(730, "unstable_unbiseptium", 0xf00, MaterialIconSet.ROUGH, 6, of(),  GENERATE_PLATE | SMELT_INTO_FLUID | GENERATE_ROD | GENERATE_GEAR | GENERATE_LONG_ROD | GENERATE_FOIL | GENERATE_BOLT_SCREW | GENERATE_RING | GENERATE_FINE_WIRE | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_PLASMA, Element.Ubs);
